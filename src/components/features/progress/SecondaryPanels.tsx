 ...
 *
 * DEUX COLONNES INDÉPENDANTES, pas une grille à six cases. Une grille
 * row-major aurait mis « Activité récente » (courte) et « Temps d'étude »
 * (haute, avec son graphique) sur la MÊME ligne : la hauteur de la ligne
 * s'aligne alors sur la plus haute des deux, et « Évolution » — juste en
 * dessous d'Activité récente dans le flux voulu — se retrouvait repoussée par
 * un grand vide. Deux colonnes en flex empilent chacune ses propres cartes
 * sur leur propre hauteur, sans dépendre de l'autre colonne.
 *
...
export function SecondaryPanels({
  ...
  return (
    ...
    >
      {/* ── Colonne de gauche : Activité récente, Évolution, Régularité ── */}
      ...
      {/* ── Colonne de droite : Temps d'étude, Objectifs, Prochaines révisions ── */}
      <div className="flex flex-col gap-3">
        <Card>
          <PanelTitle
            action={
